...
const HeaderIntroSection: React.FC = () => {
    return (
        <section className="relative mb-16 text-center w-full py-16 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-blue-900">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="floating-icon left-[10%] top-[20%]">
                    <FaCode className="text-blue-200 dark:text-blue-800 text-4xl" />
                </div>
                <div className="floating-icon right-[15%] top-[30%]">
                    <FaLaptopCode className="text-indigo-200 dark:text-indigo-800 text-4xl" />
                </div>
            </div>
