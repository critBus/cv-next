            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
              <div className="flex-1">
                <div className="flex items-start gap-3">
                  <FaUniversity className="text-2xl text-blue-400 mt-1 group-hover:scale-110 transition-transform" />
                  <div>
              ...
              <div className="flex items-center gap-2 text-gray-400 font-medium bg-gray-700/50 px-4 py-2 rounded-full">
